Nvidia Maxwell 4Gb vram compatible fork of : # acestep.cpp
...
## Fork Status 
dit-vae : generation working, cover mode working, wav default output type, 320kbps default bit-rate for MP3.

New feat :  --remix mode : works like cover mode (0.1 to 1.0 range) but on codes present in json file (from LM or ace-understand).
