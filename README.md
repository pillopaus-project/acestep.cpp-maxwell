...
## Fork Status 
dit-vae : generation working, cover mode working, new remix mode works like cover mode (0.1 to 1.0 range) but on codes present in json file; wav default output type, 320kbps default bit-rate for MP3.
